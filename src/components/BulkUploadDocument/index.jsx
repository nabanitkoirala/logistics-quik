...
function BulkUploadDocument(props) {
        ...
        <div className={styles.container}>
            <div {...getRootProps({ className: styles.dropzone })}>
                ...
                <div className={styles.dropZoneText}>
                    <span>  <a>Click to upload  </a> proof of identity</span>
                    <span>any national ID or company related documents</span>
                </div>
...
export default BulkUploadDocument;